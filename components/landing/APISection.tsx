    ...
    <section style={{ position: "relative", overflow: "hidden" }}>
      ...
      <div style={{
        ...
        <DottedCell style={{ gridColumn: "2 / span 2", minHeight: "280px" }}>
          ...
          <img src="/images/api-main-figure.svg" alt="Main API Figure" style={{ maxWidth: "460px", width: "100%" }} />
        </DottedCell>
        ...
        <DottedCell style={{ gridColumn: "1 / span 2", minHeight: "380px" }}>
          ...
          <ExternalArrow />
          <img src="/images/api-react-macos.svg" alt="React to macOS" style={{ maxWidth: "260px", width: "100%" }} />
        </DottedCell>
        ...
        <DottedCell style={{ minHeight: "300px" }}>
          ...
          <img src="/images/api-builtin-ui1.svg" alt="Built-in UI 1" style={{ maxWidth: "220px", width: "100%" }} />
        </DottedCell>
        ...
        <DottedCell style={{ minHeight: "300px" }}>
          ...
          <img src="/images/api-builtin-ui2.svg" alt="Built-in UI 2" style={{ maxWidth: "220px", width: "100%" }} />
        </DottedCell>
        ...
        <DottedCell style={{ gridColumn: "2 / span 2", minHeight: "380px" }}>
          ...
          <ExternalArrow />
          <img src="/images/api-batteries-included.svg" alt="Batteries Included" style={{ maxWidth: "220px", width: "100%" }} />
        </DottedCell>
        ...
        <DottedCell style={{ gridColumn: "1 / span 2", minHeight: "380px" }}>
          ...
          <ExternalArrow />
          <img src="/images/api-publish-store.svg" alt="Publish to Store" style={{ maxWidth: "220px", width: "100%" }} />
        </DottedCell>
        <TextCell href="https://developers.raycast.com" style={{ minHeight: "380px" }}>
          <div />
          <div>
